  ...
  */
  ...
  return (
    <>
      ...
      <Menubox menuNm={"카페라떼"} price={3300}/>
      ...
      {/* <div className='container'>
        <MemberInfo teamNm="KIA타이거즈" memberNm="강병우" />
        <MemberInfo teamNm="SSG렌더스" memberNm="김광현" />
        <MemberInfo teamNm="두산베어스" memberNm="곽빈" />
        <MemberInfo teamNm="한화이글스" memberNm="류현진" />
      </div> */}
